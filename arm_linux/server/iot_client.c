...
int main(int argc, char* argv[])
{
	et_context client;
	int v = 0,vx = 0;
	char name[128] = "Fc5wGsTuvumomVomA9G8eu59ZmUKEVFf6q";
	char *userid[2]={"Fc5wGsTuvumomVomAibJDH9jLH2M6mW9hk"};
	...
	do
    {
		...
		sscanf(str_input,"%s",str_cmd);  //��fgets ���յ�������������
